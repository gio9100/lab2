...
<head>
    ...
    <title>Términos y Condiciones - Lab-Explora</title>
    <!-- Fonts -->
...
<body>
    <div class="container container-legal">
        ...
        <p>Bienvenido a Lab-Explora. Estos Términos y Condiciones ("Términos") constituyen un acuerdo legal vinculante entre usted ("Usuario", "usted") y Lab-Explora ("nosotros", "nuestro", "la Plataforma"). Al acceder, registrarse o utilizar cualquier funcionalidad de nuestro sitio web y servicios, usted reconoce haber leído, comprendido y aceptado estos Términos en su totalidad.</p>

        <h2>1. Aceptación de los Términos</h2>
        <p>El acceso y uso de Lab-Explora está condicionado a su aceptación y cumplimiento de estos Términos. Si no está de acuerdo con alguna disposición, deberá abstenerse de utilizar la Plataforma. Nos reservamos el derecho de modificar estos Términos en cualquier momento, siendo responsabilidad del Usuario revisar periódicamente las actualizaciones. El uso continuado de la Plataforma tras las modificaciones constituirá su aceptación de los nuevos términos.</p>

        <h2>2. Descripción del Servicio</h2>
        <p>Lab-Explora es una plataforma digital especializada en la difusión, gestión y acceso a publicaciones científicas y educativas en el área de laboratorio clínico y ciencias de la salud. Nuestros servicios incluyen:</p>
        <ul>
            <li>Acceso a una biblioteca digital de publicaciones científicas verificadas</li>
            <li>Sistema de registro y autenticación de usuarios, publicadores y administradores</li>
            <li>Herramientas de interacción (comentarios, valoraciones, guardado de contenido)</li>
            <li>Generación de credenciales digitales en formato PDF</li>
            <li>Sistema de autenticación de dos factores (2FA) para publicadores y administradores</li>
        ...
        <ul>
            ...
            <li>Es mayor de edad o cuenta con el consentimiento de sus tutores legales</li>
        ...
        <ul>
            ...
            <li>Garantizar la originalidad y veracidad del contenido publicado</li>
            <li>Respetar los estándares académicos y científicos de calidad</li>
            <li>Proporcionar referencias bibliográficas cuando sea aplicable</li>
        ...
        <ul>
            ...
            <li>Interactuar mediante comentarios, valoraciones (me gusta) y guardado de publicaciones</li>
            <li>Generar y descargar credenciales digitales en formato PDF</li>
            <li>Reportar contenido inapropiado o que viole estos Términos</li>
        ...
        <ul>
            ...
            <li>Utilizar la Plataforma para difundir contenido ilegal, difamatorio, obsceno o que incite al odio</li>
            ...
            <li>Utilizar scripts automatizados, bots o cualquier método de scraping sin autorización</li>
            <li>Cargar contenido malicioso, virus o código dañino</li>
            <li>Suplantar la identidad de otros usuarios o representantes de Lab-Explora</li>
        ...
        <ul>
            ...
            <li>Realizar copias de respaldo y técnicas necesarias para la operación del servicio</li>
        ...
        <ul>
            ...
            <li>Contenga información falsa, engañosa o no verificable</li>
            <li>Sea reportada por múltiples usuarios o considerada inapropiada</li>
        ...
        <ul>
            ...
            <li>Eliminación del contenido reportado</li>
            <li>Suspensión temporal o permanente de la cuenta del publicador</li>
        </ul>
        ...
        <ul>
            ...
            <li>Código fuente, scripts, bases de datos y arquitectura del sistema</li>
            <li>Contenido generado por la Plataforma (asistente AI, algoritmos de moderación)</li>
            <li>Documentación, manuales y materiales de ayuda</li>
        </ul>
        ...
        <ul>
            ...
            <li>No somos responsables de la exactitud, integridad o actualidad del contenido publicado por terceros</li>
            <li>No nos hacemos responsables de pérdidas o daños derivados del uso o imposibilidad de uso de la Plataforma</li>
            <li>No garantizamos que la Plataforma esté libre de virus u otros componentes dañinos</li>
        ...
        <ul>
            ...
            <li>Contenido que usted publique o transmita a través de la Plataforma</li>
        ...
        <ul>
            ...
            <li>Conducta que consideremos perjudicial para otros usuarios o la Plataforma</li>
            <li>Solicitud del usuario de eliminación de su cuenta</li>
        ...
        <ul>
            ...
            <li><strong>Acuerdo completo:</strong> Estos Términos, junto con la Política de Privacidad, constituyen el acuerdo completo entre usted y Lab-Explora.</li>
