    ...
    if ($publicador) {
        ...
        if ($stmt->execute([$token, $expiracion, $email])) {
            ...
            $mail->Encoding = 'base64';    // Codificación base64
                ...
                $mail->setFrom('lab.explorer2025@gmail.com', 'Lab Explorer - Publicadores');
                // Remitente
                $mail->addAddress($email, $publicador['nombre']);
...
<!-- Abrimos el HTML en español -->
    ...
    <title>Recuperar contraseña - Publicador Lab-Explorer</title>
